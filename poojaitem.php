        ...
        <div class="col-md-10">
            <div class="row p-3 bg-white border rounded">
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image"
                        src="image\ganpati.jpg"></div>
                <div class="col-md-6 mt-5">
                    <h5>Pure Copper Murti</h5>
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-5">
                    ...
                    <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button"
                            style="background:#d12e11;">Book Now</button><button
                            class="btn btn-outline-primary btn-sm mt-2" type="button">Add to wishlist</button></div>
                </div>
            </div>
            <div class="row p-2 bg-white border rounded mt-2">
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image"
                        src="image\krishnamurti.png"></div>
                <div class="col-md-6 mt-5">
                    <h5>Pure Marble Krishna Murti</h5>
                    <div class="d-flex flex-row">
                        <div class="ratings mr-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                class="fa fa-star"></i><i class="fa fa-star"></i></div><span>310</span>
                    </div>
                    <div class="mt-1 mb-1 spec-1"><span>100% Marble</span><span class="dot"></span><span>Light
                            weight</span><span class="dot"></span><span>Best finish<br></span></div>
                    <div class="mt-1 mb-1 spec-1"><span>Unique design</span></div>
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-5">
                    <div class="d-flex flex-row align-items-center">
                        <h4 class="mr-1">Rs:2200/-</h4><span class="strike-text">Rs:3200/-</span>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button"
                            style="background:#d12e11;">Book Now</button><button
            ...
            <div class="row p-2 bg-white border rounded mt-2">
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image"
                        src="image\vishnubhagwan.png"></div>
                <div class="col-md-6 mt-5">
                    <h5>Pure Brass Vishnu Bhagwan Murti</h5>
                    <div class="d-flex flex-row">
                        <div class="ratings mr-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-5">
                    <div class="d-flex flex-row align-items-center">
                        <h4 class="mr-1">Rs:1,500/-</h4><span class="strike-text">Rs:2,500/-</span>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button"
                            style="background:#d12e11;">Book Now</button><button
            ...
            <div class="row p-2 bg-white border rounded mt-2">
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-5">
                    <div class="d-flex flex-row align-items-center">
                        <h4 class="mr-1">Rs:3,000/-</h4><span class="strike-text">Rs:4,500/-</span>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button"
                            style="background:#d12e11;">Book Now</button><button
