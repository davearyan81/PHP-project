...
$qry1 = "select * from booking where status='accept'";
$qry2 = "select * from booking where status='reject'";
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4">
                <div class="card-body">Pendeing Request <span class="badge badge-dark">
                        <?= $count; ?>
                    </span></div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                <div class="card-body">Accepted Request<span class="badge badge-dark">
                        <?= $count1; ?>
                    </span></div>
                <div class="card-footer d-flex align-items-center justify-content-between">
