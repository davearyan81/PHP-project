...
$qry = "SELECT * FROM `poojapandit` INNER JOIN `pandit` ON poojapandit.pid = pandit.pid where pandit.pid='$_GET[id]' GROUP BY pandit.fname";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product p-4">
                                    ...
                                    <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand">Purohit</span><br><br>
                                        Name : <span class="text-uppercase"><strong><?= $row['fname'].' '.$row['lname'] ?></strong><span><br><br>
                                        Email : <span class="text-uppercase"><strong><?= $row['email'] ?></strong></span><br><br>
                                        location : <span class="text-uppercase"><strong><?= $row['state'] ?> , India</strong></span><br><br>
                                    </div>
                                </div>
                            </div>
                            <!-- Pills navs -->
                            <div class="mx-1">
                                ...
                                <div class="tab-content ml-5" id="ex1-content">
                                    ...
                                    <div class="tab-pane fade p-4" id="ex1-pills-2" role="tabpanel" aria-labelledby="ex1-tab-2">
                                        Hindi/English/Sanskrit
                                    </div>
                                    <div class="tab-pane fade p-4" id="ex1-pills-3" role="tabpanel" aria-labelledby="ex1-tab-3">
                                       Puja Performed : <?php  ?>
                                    </div>
                                </div>
                                <!-- Pills content -->
